...
We looked at existing apps that had similar goals as our planned applications, which helped us to understand what was useful and what was bloat for what we intended to do. We got an idea of how our users would actually use certain features or what features were important to them from the existing applications, such as adding notes or a database of plants.
 
Gardening Guides gave us a lot of insight from the perspective of adept gardeners, and especially gave us tips that beginner gardeners would find useful and what beginners look for when they start gardening. A quick Google search of gardening guides directed us to a lot of fruit, vegetable, and herb guides. We didn’t even think about harvestable plants, but keeping track of harvesting and germination of the plants were incredibly important to many gardeners. All our guides were online, as we couldn’t find a physical garden guide due to time constraints.
 
What we found from our research was the importance of journaling the progress of growth for user. Many users want to be able to keep their own growing tips and notes for each plant, or even a diary. Another important finding was the importance of harvesting and pruning. Our initial brainstorming for this project did not include these details, as most members never gardened before. The primary focus of many apps and a major detail of gardening guides is the tracking and monitoring of plants and their needs. This was our group’s initial intention of this app, however, the findings of this research will shape many of our potential features.
...
3. Nick Geiszler
	...
	- Nick makes a few lists with different combinations of plants that could fit in the given space and shares it with her.
	- The customer chooses the list of plants she likes the best and purchases them for her new garden.
